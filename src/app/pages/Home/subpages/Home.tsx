        ...
        return Time.slice(0,5).map((element, index) => {
            ...
            <ListTile
                ...
                trailing={<div className="flex justify-center items-center gap-4">
                    <FontAwesomeIcon icon={faRedo} opacity={0.5} onClick={async() => {
                        try{
                            if(!userId) return;
    ...
    return <>
        ...
        <div className="flex justify-center items-center flex-col w-full h-[90vh] gap-3">
            <div className="rounded-2xl shadow-2xl w-[100%] h-32 relative" style={{
                background: `linear-gradient(to right, ${ThemeColor.primary}, white)`,
                ...
                <p className="text-white opacity-75 ml-2 text-sm">You've completed {taskCount} out of {taskLength}<br /> created tasks!</p>
                <SizedBox height={20}/>
            ...
            <div className="w-full rounded-3xl h-auto flex justify-center shadow items-center flex-col relative bg-white" style={{
                ...
                padding:'20px',
                    ...
                    <div
                     className="flex items-center gap-2 absolute top-2 left-4 shadow-xl p-1 pr-2" style={{
                        ...
                        <p className="text-blue-300">Tasks</p>
                    </div>
               <SizedBox height={20}/>
               {/* Begin */}
               {Object.keys(tasks).length > 0 ? (
                ...
                <Button variant={'text'} className="relative top-3" color={'inherit'} style={{color:ThemeColor.primary}} size={'small'} onClick={() => setCurrentPageIndex(1)}>View all Tasks</Button>
            </div>
            {/* End */}
            <SizedBox height={20}/>
                {/* Third Container */}

             <div className="w-full rounded-3xl h-auto shadow relative flex justify-center items-center flex-col">
                <div
                     className="flex justify-center items-center gap-2 ml-2 absolute top-2 left-2 p-1 pr-2 shadow-xl" style={{
                        ...
                        <p className="text-blue-300">Timers</p>
                </div>
                <SizedBox height={35}/>
                ...
                <SizedBox height={10}/>
                {/* Button */}
                <Button variant={'text'} className="absolute -bottom-2" color={'inherit'} style={{color:ThemeColor.primary}} onClick={() => setCurrentPageIndex(2)}>View all Timers</Button>
                <SizedBox height={20}/>
